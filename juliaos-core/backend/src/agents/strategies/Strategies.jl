...
include("strategy_proposal_analysis.jl")
include("strategy_ai_governance_chat.jl")
...
register_strategy(STRATEGY_PROPOSAL_ANALYSIS_SPECIFICATION)
register_strategy(STRATEGY_AI_GOVERNANCE_CHAT_SPECIFICATION)
